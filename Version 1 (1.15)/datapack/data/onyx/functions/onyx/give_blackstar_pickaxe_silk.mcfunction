...
# Summons Pickaxe
summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:diamond_pickaxe",Count:1b,tag:{display:{Name:'{"text":"Blackstar Pickaxe","color":"black","bold":true,"italic":true}'},CustomModelData:1,Enchantments:[{id:"minecraft:efficiency",lvl:10s},{id:"minecraft:silk_touch",lvl:1s},{id:"minecraft:unbreaking",lvl:10s},{id:"minecraft:mending",lvl:1s}]}}}
