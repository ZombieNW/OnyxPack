...
execute at @s as @p[distance=0..3,y_rotation=45..135] run execute align xyz positioned ~0.5 ~-0.5 ~0.5 run summon armor_stand ~ ~ ~ {NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Passengers:[{id:"minecraft:pig",NoGravity:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Saddle:1b,Rotation:[275F,0F],DeathLootTable:"",ActiveEffects:[{Id:14b,Amplifier:1b,Duration:999999,ShowParticles:0b}]}]}
...
execute at @s as @p[distance=0..3,y_rotation=135..225] run execute align xyz positioned ~0.5 ~-0.5 ~0.5 run summon armor_stand ~ ~ ~ {NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Passengers:[{id:"minecraft:pig",NoGravity:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Saddle:1b,Rotation:[0F,0F],DeathLootTable:"",ActiveEffects:[{Id:14b,Amplifier:1b,Duration:999999,ShowParticles:0b}]}]}
...
execute at @s as @p[distance=0..3,y_rotation=225..315] run execute align xyz positioned ~0.5 ~-0.5 ~0.5 run summon armor_stand ~ ~ ~ {NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Passengers:[{id:"minecraft:pig",NoGravity:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Saddle:1b,Rotation:[-275F,0F],DeathLootTable:"",ActiveEffects:[{Id:14b,Amplifier:1b,Duration:999999,ShowParticles:0b}]}]}
...
execute at @s as @p[distance=0..3,y_rotation=315..360] run execute align xyz positioned ~0.5 ~-0.5 ~0.5 run summon armor_stand ~ ~ ~ {NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Passengers:[{id:"minecraft:pig",NoGravity:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Saddle:1b,Rotation:[180F,0F],DeathLootTable:"",ActiveEffects:[{Id:14b,Amplifier:1b,Duration:999999,ShowParticles:0b}]}]}
execute at @s as @p[distance=0..3,y_rotation=0..45] run execute align xyz positioned ~0.5 ~-0.5 ~0.5 run summon armor_stand ~ ~ ~ {NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Passengers:[{id:"minecraft:pig",NoGravity:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Saddle:1b,Rotation:[180F,0F],DeathLootTable:"",ActiveEffects:[{Id:14b,Amplifier:1b,Duration:999999,ShowParticles:0b}]}]}
