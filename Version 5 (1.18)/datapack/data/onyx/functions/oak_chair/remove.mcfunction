...
# KILL ITEM FRAME
summon item ~ ~ ~ {Item:{id:"minecraft:item_frame",Count:1b,tag:{display:{Name:'{"text":"Oak Chair","italic":false}'},CustomModelData:101b,EntityTag:{Tags:["oak_chair"],Item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:101b}},Invulnerable:1b,Invisible:1b,Fixed:1b}}}}
