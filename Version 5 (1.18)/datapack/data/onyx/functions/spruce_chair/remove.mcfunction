...
# KILL ITEM FRAME
summon item ~ ~ ~ {Item:{id:"minecraft:item_frame",Count:1b,tag:{display:{Name:'{"text":"Spruce Chair","italic":false}'},CustomModelData:110b,EntityTag:{Tags:["spruce_chair"],Item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:110b}},Invulnerable:1b,Invisible:1b,Fixed:1b}}}}
