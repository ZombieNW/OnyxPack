...
# KILL ITEM FRAME
summon item ~ ~ ~ {Item:{id:"minecraft:item_frame",Count:1b,tag:{display:{Name:'{"text":"Crimson Chair","italic":false}'},CustomModelData:115b,EntityTag:{Tags:["crimson_chair"],Item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:115b}},Invulnerable:1b,Invisible:1b,Fixed:1b}}}}
