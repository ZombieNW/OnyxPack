...
# KILL ITEM FRAME
summon item ~ ~ ~ {Item:{id:"minecraft:item_frame",Count:1b,tag:{display:{Name:'{"text":"Warped Chair","italic":false}'},CustomModelData:116b,EntityTag:{Tags:["warped_chair"],Item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:116b}},Invulnerable:1b,Invisible:1b,Fixed:1b}}}}
