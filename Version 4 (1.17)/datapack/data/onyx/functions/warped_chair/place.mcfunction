...
kill @s
summon item_frame ~ ~ ~ {Facing:1b,Invulnerable:1b,Invisible:1b,Fixed:1b,Tags:["warped_chair","placed","furniture"],Item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:116}}}
