...
# KILL ITEM FRAME
summon item ~ ~ ~ {Item:{id:"minecraft:item_frame",Count:1b,tag:{display:{Name:'{"text":"Dark Oak Chair","italic":false}'},CustomModelData:112b,EntityTag:{Tags:["dark_oak_chair"],Item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:112b}},Invulnerable:1b,Invisible:1b,Fixed:1b}}}}
